...
//               className="text-white bg-yellow-500 focus:outline-none font-semibold text-sm p-4 text-center inline-flex items-center"
//               type="button"
...
//             <Link to="/" className="text-black bg-transparent focus:outline-none text-sm p-4 text-center inline-flex items-center hover:text-yellow-500">
//               Home
//               <svg className="w-3 h-4 mt-1 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
//                 <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
//               </svg>
...
//             <Link to="/catalog" className="text-black bg-transparent focus:outline-none text-sm p-4 text-center inline-flex items-center hover:text-yellow-500">
//               Catalog
//               <svg className="w-3 h-4 mt-1 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
//                 <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
//               </svg>
...
//             <Link to="/blog" className="text-black bg-transparent focus:outline-none text-sm p-4 text-center inline-flex items-center hover:text-yellow-500">
//               Blog
//             </Link>

//             <Link to="/pages" className="text-black bg-transparent focus:outline-none text-sm p-4 text-center inline-flex items-center hover:text-yellow-500">
//               Pages
//               <svg className="w-3 h-4 mt-1 ms-3" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 10 6">
//                 <path stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="m1 1 4 4 4-4" />
//               </svg>
...
//             <Link to="/about" className="text-black bg-transparent focus:outline-none text-sm p-4 text-center inline-flex items-center hover:text-yellow-500">
//               About us
//             </Link>
//           </div>
