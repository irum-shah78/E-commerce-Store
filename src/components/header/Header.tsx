...
//       <div className='flex flex-col md:flex-row justify-between px-32 py-4'>
...
//   return (
//     <header className='text-sm'>
//       <div className='flex flex-col md:flex-row justify-between px-6 md:px-32 py-4 md:text-center sm:items-center'>
//         <p>Need help? Call us: (+98) 0234 456 789</p>
//         <div className='flex flex-col md:flex-row  cursor-pointer'>
//           <div className='flex items-center'>
//             <img className="px-3 w-10" src={location} alt="location" />
//             <span className="md:inline">Our store</span>
//           </div>
//           <div className='flex items-center'>
//             <img className="px-3 w-10" alt="track" src={track} />
//             <span className="md:inline">Track your order</span>
//           </div>
//         </div>
//       </div>

//       <nav>
//         <div className='bg-customBlue flex flex-col md:flex-row items-center justify-between px-6 md:px-32 py-6'>
//           <img alt='logo' src={logo} className="w-24 md:w-auto" />
//           <div className='flex mt-4 md:mt-0'>
//             <div className='relative w-full md:w-auto'>
//               <input type="search" placeholder='Search anything'
//                 className='relative rounded-xl p-3 pl-6 w-full sm:w-80 border-customYellow focus:outline-none focus:border-customYellow placeholder-black' />
//               <button className='absolute text-white font-semibold rounded-xl px-6 py-3 focus:outline-none right-0 bg-customYellow'>
//                 Search
//               </button>
//             </div>
...
//             <img alt='user' src={user} className="sm:w-6" />
//             <span className="hidden sm:inline">Sign in</span>
//             <div className='flex items-center gap-1'>
//               <img alt='heart' src={heart} className="sm:w-6" />
//               <div className='bg-customYellow h-4 w-4 rounded-full flex items-center justify-center text-white text-xs'>0</div>
//               <span className='hidden sm:inline pl-2'>Wishlist</span>
//             </div>

//             <div className='relative'>
//               <div className='flex items-center gap-1' onClick={toggleCart}>
//                 <img alt='cart' src={cart} className="sm:w-6" />
//                 <span className='bg-customYellow h-4 w-4 rounded-full flex items-center justify-center text-white text-xs'>
//                   {cartItems.length}
//                 </span>
//                 <span className='hidden sm:inline pl-2'>Cart</span>
//               </div>
//               {cartOpen && (
//                 <div className='absolute right-0 w-48 bg-white shadow-lg rounded-lg pb-4 z-10'>
//                   {cartItems.length > 0 ? (
...
//       <nav className="bg-gray-200">
//         <div className="flex flex-col md:flex-row items-center justify-between px-6 md:px-32 py-4">
//           <div className="relative">
//             <button id="dropdownHoverButton"
//               className="text-white bg-customYellow focus:outline-none font-semibold text-sm p-4 inline-flex items-center"
//               type="button"
